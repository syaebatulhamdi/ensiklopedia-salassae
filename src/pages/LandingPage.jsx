...
// PERBAIKAN 1: Tambahkan ekstensi .png (atau .jpg, sesuaikan dengan file asli Anda) di akhir nama file
import fotoSawah from '../assets/foto_landing_page.jpg';
...
export default function LandingPage() {
  return (
    ...
    >
      ...
      {/* PERBAIKAN 2: Gunakan variabel {fotoSawah} di dalam src, bukan teks manual */}
      <img src={fotoSawah} alt="Latar Belakang Desa" className="absolute inset-0 w-full h-full object-cover z-0" />
